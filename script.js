...
function showModal(won) {
  ...
  if (won) {
    ...
    if (pointsEarned  === 1) {
      modalMessage.innerHTML = `You guessed "${movie.title}".<br><br><strong>${pointsEarned} point awarded!</strong>`;
    }
    else {
    ...
    modalMessage.innerHTML = `It was "${movie.title}".<br><br><strong>0 points awarded.</strong>`;
